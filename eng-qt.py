...
img_url = requests.get('https://source.unsplash.com/random/800x800?minimal').url
...
def draw_text(text, subtext):
    ...
    subtext_font = ImageFont.truetype('./fonts/TiltWarp-Regular.ttf', subtext_font_size)
    ...
    subtext_width, subtext_height = draw.textsize(subtext, font=subtext_font)
...
# test the function
with open('eng-sample.txt', 'r') as file:
...
blended_image.save('eng-image.jpg')
