...
FONT_ITALIC = ImageFont.truetype("fonts/NotoSansTamil-Light.ttf", SUBTITLE_FONT_SIZE)
FONT_REF = ImageFont.truetype("fonts/TiroTamil-Italic.ttf", REFERENCE_FONT_SIZE)
...
create_image_from_input("input-tam.txt")
